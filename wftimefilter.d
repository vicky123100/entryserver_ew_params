...
#------------------------------
 MaxMessageSize    8192  # length (bytes) of largest msg to be processed
 ...
 UseOriginalModId     1  # 0  apply wftimefilter's moduleid to 
                         #    any messages that pass the test 
                         # non-zero means apply the original instid.

 LogGap             1.5  # Minumum gap duration (seconds) for which we'll make
                         # a log entry.

 TimeJumpTolerance  120  # (in seconds) This term is used to catch packets with
